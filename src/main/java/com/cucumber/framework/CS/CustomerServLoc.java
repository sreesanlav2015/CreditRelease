...
public interface CustomerServLoc {
	...
	String search_result_xpath="//table[@pl_prop_class='CBAGrp-FW-AthenaFW-Data-Party']/tbody/tr[2]";
	...
	String submitbutton_xpath="//button[@title='Complete this assignment' and text()='Submit']";
	...
	String new_link_xpath="//a[@title='Create New Interaction']";
	String phonecall_interaction_xpath="//ul/li[1]/a";
	String xpath_search_button="//button[@title='Search']";
	String xpath_submitbtn_wrapup="//button[@title='Complete this assignment']";
	String xpath_personalQuestionOne="//div[@data-repeat-source='pyWorkPage.RiskProfileQuestionnaire(Personal).SecurityQuestionnaireList']/div[1]";
	String xpath_personalQuestionTwo="//div[@data-repeat-source='pyWorkPage.RiskProfileQuestionnaire(Personal).SecurityQuestionnaireList']/div[2]";
	String xpath_contactQuestionOne="//div[@data-repeat-source='pyWorkPage.RiskProfileQuestionnaire(Contact).SecurityQuestionnaireList']/div[1]";
}
