...
//				 waitFor(1);
	...
	public static boolean xpath_GenericMethod_IsEnabled(String xpath) throws Exception {
...
public static boolean xpath_GenericMethod_IsDisplayed(String xpath) throws Exception {
...
//				 waitFor(1);
	...
	public static void xpath_GenericMethod_Key_SendKeys(String xpath, Keys key) throws Exception {
...
//				 waitFor(1);
	...
	public static void xpath_GenericMethod_selectFromDropdownUsingVisibleTextbyclickingOnDropdown(String expath,
		    ...
		    waitFor(1);
		WebElement dropdown = driver.findElement(By.xpath(expath));
//		waitForElement(dropdown,1);
		try {
			if (driver.findElement(By.xpath(expath)).isDisplayed()) {
...
//                  waitFor(1);
	...
	public static synchronized boolean verifyTextEquals(String xpath, String expectedText) {
		...
		waitForElement(actualelement,1);
		try {
			...
			System.out.println("actualText is :" + actualelement.getText()
					+ " and expected text is: " + expectedText);
			System.out.println("text not matching" + ex);
			Reporter.log("actualText is :" + actualelement.getText()
					+ " and expected text is: " + expectedText);
			return flag;
		}
	}
