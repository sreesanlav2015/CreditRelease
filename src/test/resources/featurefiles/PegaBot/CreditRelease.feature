Feature: Credit Release
  ...
  Scenario Outline: Manual Intervention-Creating case using Pega Bot and update the case to different statuses
    ...
    Examples: 
      | SalesOrganization | DistributionChannel | Divison | Currency | CustomerRiskCategory | CustomerNumber | ShipTo     | Payer      | CreditLimit | CreditLimitUsage | NextDate   | PastDue | WeightAvgDays | CreditLimitUsage_TR | UsernameCFS | PasswordCFS | UpdateStatus1  | UpdateStatus2      | value1        | value2                | value3                      | BOTStatus |
      |              0003 |                  10 |      16 | CAD      | Z                    |     0030045988 | 0030045988 | 0030045988 |    25000000 |              100 | 05-08-2020 |       1 |            40 |            26000000 | Dummy.Kurt  | rules@0101  | Pending-Action | Resolved-Completed | Assign To CFS | Assign To Work Basket | Assign To New Assignee & WB | Success   |
  ...
  Scenario Outline: Review Risk Category-Creating case using Pega Bot and update the case to different statuses by Approving the case
    ...
    Examples: 
      ...
      |              0007 |                  10 |      11 | CAD      | P                    |     0030215751 | 0030215751 | 0030215749 |     1000000 |               60 | 21-07-2020 |     295 |            39 |             2000000 | Dummy.Remo | India123$  | Pending-RevenueSpecialistReview | Approve       | Pending-ECCIntegration | Pending - ECC Acknowledgement | Resolved-Completed | Send Mail | Approve / Reject | Success   | Update Status |
  ...
  Scenario Outline: Review Risk Category-Creating case using Pega Bot PGI date check <=3days,update RDD and the case will navigate from Revenuespecialst to CFS
    ...
    Examples: 
      | SalesOrganization | DistributionChannel | Divison | Currency | CustomerRiskCategory | CustomerNumber | ShipTo     | Payer      | CreditLimit | CreditLimitUsage | NextDate   | PastDue | WeightAvgDays | CreditLimitUsage_TR | UsernameRS | PasswordRS | UsernameCFS | PasswordCFS | UpdateStatus1                   | UpdateStatus2 | UpdateStatus3  | value1    | value2           | UpdateStatus  | OtherActionsValue | UpdateStatus4          | UpdateStatus5                 | UpdateStatus6      | BOTStatus |
      |              0002 |                  10 |      16 | USD      | Q                    |     0030001382 | 0030001382 | 0030023606 |     9990000 |              150 | 25-06-2020 |  426.95 |         13.67 |            19000000 | Dummy.Remo | India123$  | Dummy.Kurt  | rules@0101  | Pending-RevenueSpecialistReview | Approve       | Pending-Action | Send Mail | Approve / Reject | Update Status | Update RDD        | Pending-ECCIntegration | Pending - ECC Acknowledgement | Resolved-Completed | Success   |
  ...
  Scenario Outline: Review Risk Category-Creating case using Pega Bot PGI date check <=3days,Update Status and the case will navigate from Revenuespecialst to CFS
    ...
    Examples: 
      ...
      |              0002 |                  10 |      16 | USD      | Q                    |     0030001382 | 0030001382 | 0030023606 |     9990000 |              150 | 25-06-2020 |  426.95 |         13.67 |            19000000 | Dummy.Remo | India123$  | Dummy.Kurt  | rules@0101  | Pending-RevenueSpecialistReview | Send Mail | Approve / Reject | Approve       | Pending-Action | Resolved-Completed | Update Status | Success   |
  ...
  Scenario Outline: Review Risk Category Using Manual Order Revision-Creating case using Pega Bot and update the case to different statuses by Rejecting the case
    ...
    Examples: 
      ...
      |              0002 |                  10 |      16 | USD      | D                    |     0030001382 | 0030001382 | 0030023606 |    15000000 |               80 | 30-06-2020 |     253 |            45 |            25000000 | Dummy.Remo | India123$  | Pending-RevenueSpecialistReview | Reject            | Pending-Action | Dummy.Kurt  | rules@0101  | Line Item Addition       | Resolved-Completed | Assign To CFS | Assign To Work Basket | Assign To New Assignee & WB | Assign To Previous Assignee | Send Mail | Approve / Reject | Update Status | Success   |
  ...
  Scenario Outline: Review Risk Category Using Cancel Order-Creating case using Pega Bot and update the case to different statuses by Rejecting the case
    ...
    Examples: 
      ...
      |              0007 |                  10 |      11 | CAD      | P                    |     0030215751 | 0030215751 | 0030215749 |       10000 |              100 | 18-07-2020 |       0 |            19 |               20000 | Dummy.Remo | India123$  | Pending-RevenueSpecialistReview | Cancel Order      | Reject            | The order will be closed in SAP once the request is submitted | Pending-Action | Dummy.Kurt  | rules@0101  | Pending-ECCIntegration | Pending - ECC Acknowledgement | Resolved-Completed | Assign To CFS | Assign To Work Basket | Assign To New Assignee & WB | Assign To Previous Assignee | Send Mail | Approve / Reject | Update Status | Success   |
  ...
  Scenario Outline: Review Risk Category Using Change RDD-Creating case using Pega Bot and update the case to different statuses by Rejecting the case
    ...
    Examples: 
      ...
      |              0003 |                  10 |      16 | CAD      | M                    |     0030045988 | 0030045988 | 0030045988 |       10000 |              100 | 18-07-2020 |       0 |            19 |               20000 | Dummy.Remo | India123$  | Pending-RevenueSpecialistReview | Reject            | Pending-Action | Dummy.Kurt  | rules@0101  | Update RDD        | Pending-ECCIntegration | Pending - ECC Acknowledgement | Resolved-Completed | Assign To CFS | Assign To Work Basket | Assign To New Assignee & WB | Assign To Previous Assignee | Send Mail | Approve / Reject | Update Status | Success   |
  ...
  Scenario Outline: Review Risk Category - Creating case using Pega Bot and Approve the case by Team Lead
    ...
    Examples: 
      | SalesOrganization | DistributionChannel | Divison | Currency | CustomerRiskCategory | CustomerNumber | ShipTo     | Payer      | CreditLimit | CreditLimitUsage | NextDate   | PastDue | WeightAvgDays | CreditLimitUsage_TR | UsernameRS | PasswordRS | UpdateStatus1                   | OtherActionsValue | ChooseActionValue | UpdateStatus2    | UsernameTL                 | PasswordTL | UpdateStatus3 | UpdateStatus4          | UpdateStatus5                 | UpdateStatus6      | UpdateStatus  | value1    | value2      | BOTStatus |
      |              0007 |                  10 |      11 | CAD      | P                    |     0030215751 | 0030215751 | 0030215749 |     1000000 |              100 | 26-07-2020 |       0 |            19 |             3000000 | Dummy.Remo | India123$  | Pending-RevenueSpecialistReview | Cancel Order      | Reject            | Pending-TLReview | parul.rai@Areteanstech.com | May@2020   | Approve       | Pending-ECCIntegration | Pending - ECC Acknowledgement | Resolved-Completed | Update Status | Send Mail | Trigger SOA | Success   |
  ...
  Scenario Outline: Review Risk Category - Creating case using Pega Bot PGI date check <=3days,UpdateRDD and the case will navigate from Team Lead to CFS
    ...
    Examples: 
      | SalesOrganization | DistributionChannel | Divison | Currency | CustomerRiskCategory | CustomerNumber | ShipTo     | Payer      | CreditLimit | CreditLimitUsage | NextDate   | PastDue | WeightAvgDays | CreditLimitUsage_TR | UsernameRS | PasswordRS | UsernameCFS | PasswordCFS | UpdateStatus1                   | ChooseActionValue | UpdateStatus2    | UsernameTL                 | PasswordTL | OtherActionsValue | UpdateStatus3 | UpdateStatus4  | UpdateStatus5          | UpdateStatus6                 | UpdateStatus7      | UpdateStatus  | value1    | value2      | BOTStatus |
      |              0007 |                  10 |      11 | CAD      | P                    |     0030215751 | 0030215751 | 0030215749 |     1000000 |              100 | 26-06-2020 |       0 |            19 |             3000000 | Dummy.Remo | India123$  | Dummy.Kurt  | rules@0101  | Pending-RevenueSpecialistReview | Reject            | Pending-TLReview | parul.rai@Areteanstech.com | May@2020   | Update RDD        | Approve       | Pending-Action | Pending-ECCIntegration | Pending - ECC Acknowledgement | Resolved-Completed | Update Status | Send Mail | Trigger SOA | Success   |
  ...
  Scenario Outline: Review Risk Category - Creating case using Pega Bot PGI date check <=3days,UpdateStauts and the case will navigate from Team Lead to CFS
    ...
    Examples: 
      | SalesOrganization | DistributionChannel | Divison | Currency | CustomerRiskCategory | CustomerNumber | ShipTo     | Payer      | CreditLimit | CreditLimitUsage | NextDate   | PastDue | WeightAvgDays | CreditLimitUsage_TR | UsernameRS | PasswordRS | UsernameCFS | PasswordCFS | UpdateStatus1                   | ChooseActionValue | UpdateStatus2    | UsernameTL                 | PasswordTL | OtherActionsValue | UpdateStatus3 | UpdateStatus4  | UpdateStatus5      | UpdateStatus  | value1    | value2      | BOTStatus |
      |              0007 |                  10 |      11 | CAD      | P                    |     0030215751 | 0030215751 | 0030215749 |     1000000 |              100 | 26-06-2020 |       0 |            19 |             3000000 | Dummy.Remo | India123$  | Dummy.Kurt  | rules@0101  | Pending-RevenueSpecialistReview | Reject            | Pending-TLReview | parul.rai@Areteanstech.com | May@2020   | Update RDD        | Approve       | Pending-Action | Resolved-Completed | Update Status | Send Mail | Trigger SOA | Success   |
  ...
  Scenario Outline: Review Risk Category - Creating case using Pega Bot and Approve the case by Manager
    ...
    Examples: 
      | SalesOrganization | DistributionChannel | Divison | Currency | CustomerRiskCategory | CustomerNumber | ShipTo     | Payer      | CreditLimit | CreditLimitUsage | NextDate   | PastDue | WeightAvgDays | CreditLimitUsage_TR | UsernameRS | PasswordRS | UpdateStatus1                   | UpdateStatus2         | UsernameManager                        | PasswordManager | UpdateStatus3 | UpdateStatus4          | UpdateStatus5                 | UpdateStatus6      | UpdateStatus  | value1    | value2      | BOTStatus |
      |              0003 |                  10 |      16 | CAD      | K                    |     0030045988 | 0030045988 | 0030045988 |     1000000 |              100 | 18-07-2020 |       0 |            19 |            10000000 | Dummy.Remo | India123$  | Pending-RevenueSpecialistReview | Pending-ManagerReview | abhinash.kotikalapudi@areteanstech.com | India123$       | Approve       | Pending-ECCIntegration | Pending - ECC Acknowledgement | Resolved-Completed | Update Status | Send Mail | Trigger SOA | Success   |
  ...
  #
  #Examples:
  #| SalesOrganization | DistributionChannel | Divison | Currency | CustomerRiskCategory | CustomerNumber | ShipTo     | Payer      | CreditLimit | CreditLimitUsage | NextDate   | PastDue | WeightAvgDays | CreditLimitUsage_TR | UsernameRS | PasswordRS | UsernameCFS | PasswordCFS | UpdateStatus1                   | ChooseActionValue | UpdateStatus2         | UsernameManager                        | PasswordManager | OtherActionsValue | UpdateStatus3 | UpdateStatus4  | UpdateStatus5          | UpdateStatus6                 | UpdateStatus7      | UpdateStatus  | value1    | value2      | BOTStatus |
  #|              0003 |                  10 |      16 | CAD      | W                    |     0030045988 | 0030045988 | 0030045988 |     1000000 |              100 | 18-07-2020 |       0 |            19 |            10000000 | Dummy.Remo | India123$  | Dummy.Kurt  | rules@0101  | Pending-RevenueSpecialistReview | Reject            | Pending-ManagerReview | abhinash.kotikalapudi@areteanstech.com | India123$       | Update RDD        | Approve       | Pending-Action | Pending-ECCIntegration | Pending - ECC Acknowledgement | Resolved-Completed | Update Status | Send Mail | Trigger SOA | Success   |
  #Authors U.Ramakrishna, Mohan Sreekanth
  ...
  #
  #Examples:
  #| SalesOrganization | DistributionChannel | Divison | Currency | CustomerRiskCategory | CustomerNumber | ShipTo     | Payer      | CreditLimit | CreditLimitUsage | NextDate   | PastDue | WeightAvgDays | CreditLimitUsage_TR | UsernameRS | PasswordRS | UsernameCFS | PasswordCFS | UpdateStatus1                   | ChooseActionValue | UpdateStatus2         | UsernameManager                        | PasswordManager | UpdateStatus3 | UpdateStatus4  | UpdateStatus5      | UpdateStatus  | value1    | value2      | BOTStatus |
  #|              0003 |                  10 |      16 | CAD      | L                    |     0030045988 | 0030045988 | 0030045988 |     1000000 |              100 | 18-07-2020 |       0 |            19 |            10000000 | Dummy.Remo | India123$  | Dummy.Kurt  | rules@0101  | Pending-RevenueSpecialistReview | Reject            | Pending-ManagerReview | abhinash.kotikalapudi@areteanstech.com | India123$       | Approve       | Pending-Action | Resolved-Completed | Update Status | Send Mail | Trigger SOA | Success   |
  #Authors U.Ramakrishna, Mohan Sreekanth
  ...
  Scenario Outline: Review Risk Category - Creating case using Pega Bot and Approve the case by Director
    ...
    Examples: 
      | SalesOrganization | DistributionChannel | Divison | Currency | CustomerRiskCategory | CustomerNumber | ShipTo     | Payer      | CreditLimit | CreditLimitUsage | NextDate   | PastDue | WeightAvgDays | CreditLimitUsage_TR | UsernameRS | PasswordRS | UpdateStatus1                   | UpdateStatus2          | UsernameDirector                   | PasswordDirector | UpdateStatus3 | UpdateStatus4          | UpdateStatus5                 | UpdateStatus6      | UpdateStatus  | value1    | value2      | BOTStatus |
      ...
      #|              0007 |                  10 |      11 | CAD      | U                    |     0030215751 | 0030215751 | 0030215749 |             |              100 | 18-07-2020 |       0 |            19 |              100000 | Dummy.Remo | India123$  | Pending-RevenueSpecialistReview | Pending-DirectorReview | sudheer.meetakoti@Areteanstech.com | rules@1234       | Approve       | Pending-ECCIntegration | Pending - ECC Acknowledgement | Resolved-Completed | Update Status | Send Mail | Trigger SOA | Success   |
      |              0007 |                  10 |      11 | CAD      | U                    |     0030215751 | 0030215751 | 0030215749 |             |              100 | 18-07-2020 |       0 |            19 |                     | Dummy.Remo | India123$  | Pending-RevenueSpecialistReview | Pending-DirectorReview | sudheer.meetakoti@Areteanstech.com | rules@1234       | Approve       | Pending-ECCIntegration | Pending - ECC Acknowledgement | Resolved-Completed | Update Status | Send Mail | Trigger SOA | Success   |
      |              0007 |                  10 |      11 | CAD      | U                    |     0030215751 | 0030215751 | 0030215749 |     1000000 |              100 | 18-07-2020 |       0 |            19 |                     | Dummy.Remo | India123$  | Pending-RevenueSpecialistReview | Pending-DirectorReview | sudheer.meetakoti@Areteanstech.com | rules@1234       | Approve       | Pending-ECCIntegration | Pending - ECC Acknowledgement | Resolved-Completed | Update Status | Send Mail | Trigger SOA | Success   |
  ...
  Scenario Outline: Review Risk Category - Creating case using Pega Bot PGI date check <=3days,UpdateRDD and the case will navigate from Director to CFS
    ...
    Examples: 
      | SalesOrganization | DistributionChannel | Divison | Currency | CustomerRiskCategory | CustomerNumber | ShipTo     | Payer      | CreditLimit | CreditLimitUsage | NextDate   | PastDue | WeightAvgDays | CreditLimitUsage_TR | UsernameRS | PasswordRS | UsernameCFS | PasswordCFS | UpdateStatus1                   | ChooseActionValue | UpdateStatus2          | UsernameDirector                   | PasswordDirector | OtherActionsValue | UpdateStatus3 | UpdateStatus4  | UpdateStatus5          | UpdateStatus6                 | UpdateStatus7      | UpdateStatus  | value1    | value2      | BOTStatus |
      |              0007 |                  10 |      11 | CAD      | U                    |     0030215751 | 0030215751 | 0030215749 |     1000000 |              100 | 23-06-2020 |       0 |            19 |            31000000 | Dummy.Remo | India123$  | Dummy.Kurt  | rules@0101  | Pending-RevenueSpecialistReview | Reject            | Pending-DirectorReview | sudheer.meetakoti@Areteanstech.com | rules@1234       | Update RDD        | Approve       | Pending-Action | Pending-ECCIntegration | Pending - ECC Acknowledgement | Resolved-Completed | Update Status | Send Mail | Trigger SOA | Success   |
  ...
  Scenario Outline: Review Risk Category - Creating case using Pega Bot PGI date check <=3days,UpdateStatus and the case will navigate from Director to CFS
    ...
    Examples: 
      | SalesOrganization | DistributionChannel | Divison | Currency | CustomerRiskCategory | CustomerNumber | ShipTo     | Payer      | CreditLimit | CreditLimitUsage | NextDate   | PastDue | WeightAvgDays | CreditLimitUsage_TR | UsernameRS | PasswordRS | UsernameCFS | PasswordCFS | UpdateStatus1                   | ChooseActionValue | UpdateStatus2          | UsernameDirector                   | PasswordDirector | UpdateStatus3 | UpdateStatus4  | UpdateStatus5      | UpdateStatus  | value1    | value2      | BOTStatus |
      |              0007 |                  10 |      11 | CAD      | U                    |     0030215751 | 0030215751 | 0030215749 |     1000000 |              100 | 23-06-2020 |       0 |            19 |            31000000 | Dummy.Remo | India123$  | Dummy.Kurt  | rules@0101  | Pending-RevenueSpecialistReview | Reject            | Pending-DirectorReview | sudheer.meetakoti@Areteanstech.com | rules@1234       | Approve       | Pending-Action | Resolved-Completed | Update Status | Send Mail | Trigger SOA | Success   |
  ...
  Scenario Outline: TL review Using Manual Order Revision-Creating case using Pega Bot and update the case to different statuses by Rejecting the case
    ...
    Examples: 
      | SalesOrganization | DistributionChannel | Divison | Currency | CustomerRiskCategory | CustomerNumber | ShipTo     | Payer      | CreditLimit | CreditLimitUsage | NextDate   | PastDue | WeightAvgDays | CreditLimitUsage_TR | UsernameRS | PasswordRS | UpdateStatus1                   | ChooseActionValue | UpdateStatus3  | UsernameCFS | PasswordCFS | ManualOrderRevisionValue | UpdateStatus4      | UpdateStatus  | value1        | value2                | value3                      | value4                      | value5    | value6           | BOTStatus |
      |              0003 |                  10 |      16 | CAD      | F                    |     0030045988 | 0030045988 | 0030045988 |           0 |               58 | 13-07-2020 |       0 |            25 |                   0 | Dummy.Remo | India123$  | Pending-RevenueSpecialistReview | Reject            | Pending-Action | Dummy.Kurt  | rules@0101  | Line Item Cancellation   | Resolved-Completed | Update Status | Assign To CFS | Assign To Work Basket | Assign To New Assignee & WB | Assign To Previous Assignee | Send Mail | Approve / Reject | Success   |
  ...
  Scenario Outline: TL Review Using Cancel Order-Creating case using Pega Bot and update the case to different statuses by Rejecting the case
    ...
    Examples: 
      | SalesOrganization | DistributionChannel | Divison | Currency | CustomerRiskCategory | CustomerNumber | ShipTo     | Payer      | CreditLimit | CreditLimitUsage | NextDate   | PastDue | WeightAvgDays | Creditlimitusage_TR | UsernameRS | PasswordRS | UpdateStatus1                   | OtherActionsValue | Message                                                       | ChooseActionValue | UpdateStatus2  | UsernameCFS | PasswordCFS | UpdateStatus3          | UpdateStatus4                 | UpdateStatus5      | UpdateStatus  | value1        | value2                | value3                      | value4                      | value5    | value6           | BOTStatus |
      |              0007 |                  10 |      11 | CAD      | A                    |     0030215751 | 0030215751 | 0030215749 |      210000 |              100 | 18-07-2020 |      31 |            38 |              220000 | Dummy.Remo | India123$  | Pending-RevenueSpecialistReview | Cancel Order      | The order will be closed in SAP once the request is submitted | Reject            | Pending-Action | Dummy.Kurt  | rules@0101  | Pending-ECCIntegration | Pending - ECC Acknowledgement | Resolved-Completed | Update Status | Assign To CFS | Assign To Work Basket | Assign To New Assignee & WB | Assign To Previous Assignee | Send Mail | Approve / Reject | Success   |
  ...
  Scenario Outline: TL Review Using Change RDD-Creating case using Pega Bot and update the case to different statuses by Rejecting the case
    ...
    Examples: 
      | SalesOrganization | DistributionChannel | Divison | Currency | CustomerRiskCategory | CustomerNumber | ShipTo     | Payer      | CreditLimit | CreditLimitUsage | NextDate   | PastDue | WeightAvgDays | Creditlimitusage_TR | UsernameRS | PasswordRS | UpdateStatus1                   | ChooseActionValue | UpdateStatus2  | UsernameCFS | PasswordCFS | OtherActionsValue | UpdateStatus3          | UpdateStatus4                 | UpdateStatus5      | UpdateStatus  | value1        | value2                | value3                      | value4                      | value5    | value6           | BOTStatus |
      |              0003 |                  10 |      16 | CAD      | B                    |     0030045988 | 0030045988 | 0030045988 |      600000 |              100 | 16-07-2020 |       5 |            38 |              700000 | Dummy.Remo | India123$  | Pending-RevenueSpecialistReview | Reject            | Pending-Action | Dummy.Kurt  | rules@0101  | Update RDD        | Pending-ECCIntegration | Pending - ECC Acknowledgement | Resolved-Completed | Update Status | Assign To CFS | Assign To Work Basket | Assign To New Assignee & WB | Assign To Previous Assignee | Send Mail | Approve / Reject | Success   |
  ...
  Scenario Outline: TL Review-Creating case using Pega Bot and update the case to different statuses by Approving the case
    ...
    Examples: 
      | SalesOrganization | DistributionChannel | Divison | Currency | CustomerRiskCategory | CustomerNumber | ShipTo     | Payer      | CreditLimit | CreditLimitUsage | NextDate   | PastDue | WeightAvgDays | CreditLimitUsage_TR | UsernameRS | PasswordRS | UpdateStatus1                   | UpdateStatus2 | UpdateStatus3          | UpdateStatus4                 | UpdateStatus5      | UpdateStatus  | value1    | value2           | BOTStatus |
      |              0007 |                  10 |      11 | CAD      | A                    |     0030215751 | 0030215751 | 0030215749 |        1000 |               67 | 18-07-2020 |      31 |            30 |                2000 | Dummy.Remo | India123$  | Pending-RevenueSpecialistReview | Approve       | Pending-ECCIntegration | Pending - ECC Acknowledgement | Resolved-Completed | Update Status | Send Mail | Approve / Reject | Success   |
  ...
  Scenario Outline: TL Review - Creating case using Pega Bot and Approve the case by Team Lead
    ...
    Examples: 
      ...
      |              0007 |                  10 |      11 | CAD      | A                    |     0030215751 | 0030215751 | 0030215749 |     1000000 |              100 | 18-07-2020 |      31 |            19 |             3000000 | Dummy.Remo | India123$  | Pending-RevenueSpecialistReview | Pending-TLReview | parul.rai@Areteanstech.com | May@2020   | Approve       | Pending-ECCIntegration | Pending - ECC Acknowledgement | Resolved-Completed | Update Status | Send Mail | Trigger SOA | Success   |
  ...
  Scenario Outline: TL Review - Creating case using Pega Bot and Approve the case by Director
    ...
    Examples: 
      ...
      |              0007 |                  10 |      11 | CAD      | F                    |     0030215751 | 0030215751 | 0030215749 |     1000000 |               58 | 18-07-2020 |       0 |            25 |            31000000 | Dummy.Remo | India123$  | Pending-RevenueSpecialistReview | Pending-DirectorReview | sudheer.meetakoti@Areteanstech.com | rules@1234       | Approve       | Pending-ECCIntegration | Pending - ECC Acknowledgement | Resolved-Completed | Update Status | Send Mail | Trigger SOA |      31.00 | Success   |
  ...
  Scenario Outline: Revenue Specialist sending mail and Purpose Of Email is Pending Resonse
    ...
    Examples: 
      ...
      |              0001 |                  10 |      16 | USD      | P                    |     0030001125 | 0030001125 | 0030023426 |      600000 |               80 | 26-06-2020 |       5 |            30 |              700000 | Dummy.Remo | India123$  | Pending-RevenueSpecialistReview | Send Mail         | Pending Response | Sales            | Pending-Response | ramakrishna.uppara@areteanstech.com | Revenue Management Team | Customer Contact       | Sales                  | Update Status | Success   |
  ...
  Scenario Outline: Customer Facing Specialist sending mail and Purpose Of Email is Pending Resonse
    ...
    Examples: 
      ...
      |              0003 |                  10 |      16 | CAD      | Z                    |     0030045988 | 0030045988 | 0030045988 |    25000000 |              100 | 05-08-2020 |       1 |            40 |            26000000 | Dummy.Kurt | rules@0101 | Pending-Action | Pending-Response | Pending Response | Customer Contact | mohan.akula@areteanstech.com | true  | Update Status | Success   |
  ...
  Scenario Outline: Revenue Specialist and Customer Facing Specialist sending mail and Purpose Of Email is Information Only
    ...
    Examples: 
      | SalesOrganization | DistributionChannel | Divison | Currency | CustomerRiskCategory | CustomerNumber | ShipTo     | Payer      | CreditLimit | CreditLimitUsage | NextDate   | PastDue | WeightAvgDays | Creditlimitusage_TR | Username   | Password  | UpdateStatus1                   | OtherActionsValue | PurposeOfEmail   | ContactPerson                | UpdateStatus  | value | BOTStatus |
      ...
      |              0003 |                  10 |      16 | CAD      | M                    |     0030045988 | 0030045988 | 0030045988 |      600000 |               80 | 26-06-2020 |       5 |            30 |              700000 | Dummy.Remo | India123$ | Pending-RevenueSpecialistReview | Send Mail         | Information Only | mohan.akula@areteanstech.com | Update Status | true  | Success   |
  ...
  Scenario Outline: Verify that when user selects Assign To CFS then case should be assigned to the CFS selected in Parties & Org tab.
    ...
    Examples: 
      | SalesOrganization | DistributionChannel | Divison | Currency | CustomerRiskCategory | CustomerNumber | ShipTo     | Payer      | CreditLimit | CreditLimitUsage | NextDate   | PastDue | WeightAvgDays | CreditLimitUsage_TR | UsernameRS | PasswordRS | UsernameCFS | PasswordCFS | OtherActionsValue | UpdateStatus3          | UpdateStatus4                 | UpdateStatus5      | Actiontypeworkstatus | Actiontypecaseresponsible | expectedstatus_oldvalue1 | expectedstatus_newvalue1        | expectedcaseresponsible_oldvalue1 | expectedcaseresponsible_newvalue1 | value1        | value2                | value3                      | BOTStatus |
      |              0003 |                  10 |      16 | CAD      | M                    |     0030045988 | 0030045988 | 0030045988 |       10000 |              100 | 18-07-2020 |       0 |            19 |               20000 | Dummy.Remo | India123$  | Dummy.Kurt  | rules@0101  | Update RDD        | Pending-ECCIntegration | Pending - ECC Acknowledgement | Resolved-Completed | Work status          | Case Responsible          | Pending-BOTResponse      | Pending-RevenueSpecialistReview | Revenue Specialist WB             | Dummy.Kurt                        | Assign To CFS | Assign To Work Basket | Assign To New Assignee & WB | Success   |
  ...
  Scenario Outline: Verfiy that Assign To Previous assignee should assign the case to the previous operator who has performed the action on the case.
    ...
    Examples: 
      | SalesOrganization | DistributionChannel | Divison | Currency | CustomerRiskCategory | CustomerNumber | ShipTo     | Payer      | CreditLimit | CreditLimitUsage | NextDate   | PastDue | WeightAvgDays | CreditLimitUsage_TR | UsernameRS | PasswordRS | UsernameCFS | PasswordCFS | OtherActionsValue | UpdateStatus3          | UpdateStatus4                 | UpdateStatus5      | Actiontypeworkstatus | Actiontypecaseresponsible | expectedstatus_oldvalue1 | expectedstatus_newvalue1        | expectedcaseresponsible_oldvalue1 | expectedcaseresponsible_newvalue1 | PrevoiusAssignee | value1        | value2                | value3                      | value4                      | BOTStatus |
      |              0003 |                  10 |      16 | CAD      | M                    |     0030045988 | 0030045988 | 0030045988 |       10000 |              100 | 18-07-2020 |       0 |            19 |               20000 | Dummy.Remo | India123$  | Dummy.Kurt  | rules@0101  | Update RDD        | Pending-ECCIntegration | Pending - ECC Acknowledgement | Resolved-Completed | Work status          | Case Responsible          | Pending-BOTResponse      | Pending-RevenueSpecialistReview | Revenue Specialist WB             | Dummy.Kurt                        | Dummy.Remo       | Assign To CFS | Assign To Work Basket | Assign To New Assignee & WB | Assign To Previous Assignee | Success   |
  ...
  Scenario Outline: Verify that all the workbaskets related to Organizational unit should be displayed in the workqueue dropdown of Assign To New Assignee.
    ...
    Examples: 
      | SalesOrganization | DistributionChannel | Divison | Currency | CustomerRiskCategory | CustomerNumber | ShipTo     | Payer      | CreditLimit | CreditLimitUsage | NextDate   | PastDue | WeightAvgDays | CreditLimitUsage_TR | UsernameRS | PasswordRS | UsernameCFS | PasswordCFS | OtherActionsValue | UpdateStatus3          | UpdateStatus4                 | UpdateStatus5      | Actiontypeworkstatus | Actiontypecaseresponsible | expectedstatus_oldvalue1 | expectedstatus_newvalue1        | expectedcaseresponsible_oldvalue1 | expectedcaseresponsible_newvalue1 | PrevoiusAssignee | NewAssignee | AssignToType | value1        | value2                | value3                      | BOTStatus |
      |              0001 |                  10 |      16 | USD      | X                    |     0030001125 | 0030001125 | 0030023426 |     9000000 |              100 | 10-07-2020 |       5 |            35 |            10000000 | Dummy.Remo | India123$  | Dummy.Kurt  | rules@0101  | Update RDD        | Pending-ECCIntegration | Pending - ECC Acknowledgement | Resolved-Completed | Work status          | Case Responsible          | Pending-BOTResponse      | Pending-RevenueSpecialistReview | Revenue Specialist WB             | Dummy.Kurt                        | Dummy.Remo       | dummy.remo  | Operator     | Assign To CFS | Assign To Work Basket | Assign To New Assignee & WB | Success   |
  ...
  Scenario Outline: Verify that all the workbaskets related to Organizational unit should be displayed in the workqueue dropdown of Assign To New Assignee.
    ...
    Examples: 
      | SalesOrganization | DistributionChannel | Divison | Currency | CustomerRiskCategory | CustomerNumber | ShipTo     | Payer      | CreditLimit | CreditLimitUsage | NextDate   | PastDue | WeightAvgDays | CreditLimitUsage_TR | UsernameRS | PasswordRS | UsernameCFS | PasswordCFS | OtherActionsValue | UpdateStatus3          | UpdateStatus4                 | UpdateStatus5      | Actiontypeworkstatus | Actiontypecaseresponsible | expectedstatus_oldvalue1 | expectedstatus_newvalue1        | expectedcaseresponsible_oldvalue1 | expectedcaseresponsible_newvalue1 | PrevoiusAssignee | NewAssignee                           | AssignToType | WorkBasket                            | value1        | value2                | value3                      | BOTStatus |
      |              0001 |                  10 |      16 | USD      | X                    |     0030001125 | 0030001125 | 0030023426 |     9000000 |              100 | 10-07-2020 |       5 |            35 |            10000000 | Dummy.Remo | India123$  | Dummy.Kurt  | rules@0101  | Update RDD        | Pending-ECCIntegration | Pending - ECC Acknowledgement | Resolved-Completed | Work status          | Case Responsible          | Pending-BOTResponse      | Pending-RevenueSpecialistReview | Revenue Specialist WB             | Dummy.Kurt                        | Dummy.Remo       | UnileverO2C:Revenue Specialist Basket | Work queue   | UnileverO2C:Revenue Specialist Basket | Assign To CFS | Assign To Work Basket | Assign To New Assignee & WB | Success   |
